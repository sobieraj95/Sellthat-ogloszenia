...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Sony Play Station 3 500G</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 13 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/710904977_1_644x461_sony-play-station-3-500g-sierpc.jpg'/>
		<p class='artykul_opis'> Mam na sprzedaż konsole PS3 w pełni działa w zestawie pad pudełko kable. O więcej informacji proszę pytać w wiadomości </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 200 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 721480047 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 231555 </h2>
