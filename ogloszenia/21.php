...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>!! Audi A6 C5 2.5 TDI !!</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 21 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/636389633_1_644x461_-audi-a6-c5-25-tdi-piekary-slaskie_rev016.jpg'/>
		<p class='artykul_opis'> Witam Oferuje ładnego Audi A-6 jak na swoje lata . Samochód czysty , zadbany , sprawny technicznie po wymianie pompy wtryskowej ,pasek rozrządu jeszcze w dobrym stanie , . Opłaty są ważne , przegląd do Maja 2019 , a ubezpieczenie OC - miesięczne . .Tel : 602-274-470 </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 4600 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 884860514 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 65666 </h2>
		<form action='../mojsell/nowa_wiadomosc.php' method='post'>
		<input type='hidden' name='id' value='sobieraj'>
