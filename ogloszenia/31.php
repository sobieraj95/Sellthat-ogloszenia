...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Felgi metalowe</h2>
		<p>Właściciel: przemek  |  ID ogłoszenia: 31 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/713312259_1_644x461_felgi-metalowe-krakow.jpg'/>
		<p class='artykul_opis'> felgi urzywane np renault r4 z 1974 r
zdrowe nie picowane
4 sztuki </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 2800 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 721480047 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 435 </h2>
