...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Huawei P10 lite dual sim Sapph</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 11 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/701317939_1_1000x700_huawei-p10-lite-dual-sim-sapphire-black-stan-bdb-kolobrzeg_rev008.jpg'/>
		<p class='artykul_opis'> Sprzedam Huawei P10 lite DUAL SIM w kolorze Sapphire Black
sprawny bez simlocka, Telefon bez rys i obić, stan niemal idealny, bez brandu operatora
W skład zestawu wchodzą:
- Telefon
- ładowarka
- kabel usb
- słuchawki
- kartonik z instrukcją </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 549 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 884860514 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br>  </h2>
