...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Sukienka DARIA Just Unique M/L</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 24 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/705480683_1_644x461_sukienka-daria-just-unique-m-l-gora.jpg'/>
		<p class='artykul_opis'> Sukienka DARIA

Sukienka z perłowego materiału w odcieniu złota, przez środek przeszyta pasem z beżowej ekoskóry, na ramionach ozdobne pagony.
Z tyłu zapinana na kryty zamek.

Rozmiar: M/L </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 80 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 721480047 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 564576 </h2>
