...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Fiat 126p</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 20 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/707403549_1_644x461_fiat-126p-jaslo.jpg'/>
		<p class='artykul_opis'> Po remoncie świeżo pomalowany więcej info pod numerem telefonu </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 5800 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 721480047 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 593756 </h2>
