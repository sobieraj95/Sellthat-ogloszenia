...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Garnitur vistula</h2>
		<p>Właściciel: przemek  |  ID ogłoszenia: 34 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/716000943_1_644x461_garnitur-vistula-radom.jpg'/>
		<p class='artykul_opis'> Witam. Mam do sprzedania garnitur vistula. Wymiary na zdjęciach. Stan idealny. Cena w salonie 1400 zł. </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 200 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 884860514 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 6546 </h2>
		<form action='../mojsell/nowa_wiadomosc.php' method='post'>
		<input type='hidden' name='id' value='przemek'>
