...
<div id='kontener_calosc'>
	...
	<div id='kontener_artykul'>
		<h2>Elegancka bordowa sukienka</h2>
		<p>Właściciel: sobieraj  |  ID ogłoszenia: 23 </p>
		<img src='https://img01-olxpl.akamaized.net/img-olxpl/688361341_4_644x461_elegancka-bordowa-sukienka-moda.jpg'/>
		<p class='artykul_opis'> Sukienkę miałam 2 razy na sobie, dodatkowo bolerko, rozmiar 38 ale ciasna w biuście, odbiór osobisty lub wysyłka na koszt kupującego. Zapraszam do obejrzenia wszystkich moich ogłoszeń :) </p>	
	</div>
	
	<div id='kontener_kontakt'>
		<h2 class='cena'>Cena: <br> 29 zł</h2>
		<h2 class='kontakt'>Kontakt tel:<br> 721480047 </h2>
		<h2 class='kontakt_gg'>Kontakt GG:<br> 555 </h2>
